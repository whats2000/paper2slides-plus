...
本專案建立在由 [takashiishida](https://github.com/takashiishida) 建立的原始 [paper2slides](https://github.com/takashiishida/paper2slides) 專案的優秀成果之上。使用 LLM 將研究論文轉換為簡報這一創新概念，構成了這個分支的基礎。

**paper2slides-plus** 在原始專案的基礎上進行了擴充與改進，以支援更廣泛的使用情境和工作流程。其核心理念與方法仍然根植於原專案的優秀設計。
