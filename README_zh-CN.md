...
本项目建立在由 [takashiishida](https://github.com/takashiishida) 创建的原始 [paper2slides](https://github.com/takashiishida/paper2slides) 项目的优秀工作之上。使用 LLM 将研究论文转换为幻灯片这一创新思路，构成了这个分支的基础。

**paper2slides-plus** 在原始项目的基础上进行了扩展和改进，以支持更广泛的使用场景和工作流程。其核心理念和方法仍然根植于原项目的优秀设计。
