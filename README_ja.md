...
本プロジェクトは、[takashiishida](https://github.com/takashiishida) 氏によって作成されたオリジナルの [paper2slides](https://github.com/takashiishida/paper2slides) の優れた成果の上に成り立っています。LLM を用いて研究論文をスライドへ変換するという革新的な発想は、このフォークの基盤となっています。

**paper2slides-plus** は、より幅広いユースケースとワークフローに対応するために、オリジナルの機能を拡張し改善したものです。中核となるコンセプトと手法は、元のプロジェクトの優れた設計に根ざしています。
